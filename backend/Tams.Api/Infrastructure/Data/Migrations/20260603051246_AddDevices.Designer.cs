...
namespace Tams.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260603051246_AddDevices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tams.Api.Domain.Entities.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Tams.Api.Domain.Entities.Device", b =>
                {
                    b.HasOne("Tams.Api.Domain.Entities.AssetVariant", "AssetVariant")
                        .WithMany()
                        .HasForeignKey("AssetVariantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("AssetVariant");
                });
